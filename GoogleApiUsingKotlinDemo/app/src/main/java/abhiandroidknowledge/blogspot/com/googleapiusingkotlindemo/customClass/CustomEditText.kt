...
import abhiandroidknowledge.blogspot.com.googleapiusingkotlindemo.interfaces.DrawableClickListener
...
class CustomEditText : TextInputEditText {
    ...
    public fun setDrawableClickListener(listener: DrawableClickListener) {
